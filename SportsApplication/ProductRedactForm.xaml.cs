...
namespace SportsApplication
{
    public partial class ProductRedactForm : Window
    {
        ...
        private void LoadProductData()
        {
            ...
            {
                ImageProduct.Source = new BitmapImage(new Uri($"Images/{product.ProductPhoto}", UriKind.RelativeOrAbsolute));
            }
            else
            {
                ImageProduct.Source = new BitmapImage(new Uri("picture.png", UriKind.RelativeOrAbsolute));
            }
        }
